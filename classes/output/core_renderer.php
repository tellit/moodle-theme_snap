...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    /**
     * Output moodle blocks and Cass wrapper with edit button.
     * @return string
     */
...
<div class="news-article clearfix">
    ...
    <div class="news-article-message" tabindex="-1">
        {$message}
        <div><hr><a class="cass-action-icon cass-icon-close toggle" href="#">
...
HTML;
    ...
    /**
     * Return Cass's logo url for login.mustache
     *
     * @param int $maxwidth not used in Cass.
     * @param int $maxheight not used in Cass.
