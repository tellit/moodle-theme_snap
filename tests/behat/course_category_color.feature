...
#
# Test the Category color setting for cass.
#
# @package   theme_cass
...
@theme @theme_cass
Feature: When the moodle theme is set to Cass, admins can change the color for a given category.
  ...
  @javascript
  Scenario: Go to Cass settings page and put a wrong JSON text in it.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I navigate to "Cass" node in "Site administration>Appearance>Themes"
  ...
  @javascript
  Scenario: Go to Cass settings page and put a valid JSON text in it.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I navigate to "Cass" node in "Site administration>Appearance>Themes"
  ...
  @javascript
  Scenario: Go to Cass settings page and put a valid JSON text in it but with no existing categories.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I navigate to "Cass" node in "Site administration>Appearance>Themes"
  ...
  @javascript
  Scenario: Go to Cass settings page and put a not valid color in the JSON text.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I navigate to "Cass" node in "Site administration>Appearance>Themes"
  ...
  @javascript
  Scenario: Go to Cass settings page and put a wrong JSON text with duplicated IDs.
    Given I log in as "admin"
      And I am on site homepage
      And I click on "#admin-menu-trigger" "css_element"
      And I navigate to "Cass" node in "Site administration>Appearance>Themes"
