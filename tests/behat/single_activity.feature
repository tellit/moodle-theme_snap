...
#
# Tests that Single Activity format remains usable in Cass
#
# @package   theme_cass
# @author    Sam Chaffee
...
@theme @theme_cass
Feature: Use the Single Activity format in Cass
  In order to use the Single Activity format in Cass
  As a teacher
  I need to be able to create a course using Single Activity format without errors in Cass
  ...
  Scenario: Admin creates a single activity course with a Glossary
    ...
    And I set the following fields to these values:
      | Course full name | Test single activity in Cass|
