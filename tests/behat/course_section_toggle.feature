...
@theme @theme_cass
Feature: When the moodle theme is set to Cass, teachers can toggle the visibility of course sections in read mode and
  edit mode.
  ...
  Scenario: In read mode, teacher hides section.
    ...
    And I click on "#section-2 .cass-visibility.cass-hide" "css_element"
    And I wait until "#section-2 .cass-visibility.cass-show" "css_element" exists
    ...
    Given I click on "#section-2 .cass-visibility.cass-show" "css_element"
    And I wait until "#section-2 .cass-visibility.cass-hide" "css_element" exists
  ...
  hide section.
    ...
    And I click on "#section-1 .cass-visibility.cass-hide" "css_element"
  ...
  Scenario: In read mode, student cannot hide section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 2"
    Then "#section-2 .cass-visibility" "css_element" should not exist
