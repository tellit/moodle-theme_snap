...
/**
 * Overrides to make behat course steps work with Cass.
 *
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_cass_behat_course extends behat_course {
    ...
    public function i_add_to_section($activity, $section) {
        ...
        $xpath = "//*[@id='cass-modchooser-modal']//a[text()='$activity']";
