...
@theme @theme_cass
Feature: When setting an erroneous field in settings, cass auto-expands area.
  ...
  Scenario: Go to Assignment settings page and put wrong max grade.
    ...
    And I click on ".cass-activity[data-type='Assignment']  a.cass-edit-asset" "css_element"
