...
/**
 * @module theme_cass/dndupload-lazy
 */
define(['jquery', 'core/yui', 'theme_cass/util'],
    function($, YUI, util) {
        var self = this;
        ...
        self.decorateCourseDNDUpload = function(Y, options) {
            ...
            /* global themeCassCourseFileHandlers */
            if (themeCassCourseFileHandlers) {
                options.handlers = themeCassCourseFileHandlers;
            } else {
                options.handlers = {};
            }
