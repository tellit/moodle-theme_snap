...
$string['hidecoursepage'] = 'Hide default Moodle course page';
$string['hidecoursepagedesc'] = "To prevent unneccessary &lsquo;Hub-And-Spoke&rsquo; style navigation between the Course page and each activity module.";
...
$string['questionsemanticactivation-ddimageortext'] = '';
$string['questionsemanticactivation-ddmarker'] = '';
$string['questionsemanticactivation-ddwtos'] = '';
$string['questionsemanticactivation-description'] = '';
$string['questionsemanticactivation-essay'] = '';
$string['questionsemanticactivation-gapselect'] = '';
$string['questionsemanticactivation-match'] = '';
$string['questionsemanticactivation-missingtype'] = '';
$string['questionsemanticactivation-multianswer'] = '';
$string['questionsemanticactivation-multichoice'] = '';
$string['questionsemanticactivation-numerical'] = '';
$string['questionsemanticactivation-random'] = '';
$string['questionsemanticactivation-randomsamatch'] = '';
$string['questionsemanticactivation-shortanswer'] = '';
$string['questionsemanticactivation-tests'] = '';
$string['questionsemanticactivation-truefalse'] = 'True / False';
...
$string['scrapecurrentactivity'] = 'Embed current activity';
$string['scrapecurrentactivitydesc'] = 'Embed content from the current activity into the course page';
