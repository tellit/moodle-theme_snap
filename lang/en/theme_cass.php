...
$string['cachedef_generalstaticappcache'] = 'Cass general static application level cache';
...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the Cass theme. For the best experience Moodlerooms recommends using the Topics or Weekly course formats with the Snap theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['showallsectionsdisabled'] = 'Due to its design language, "Show all sections on one page" isn\'t available in Cass.';
